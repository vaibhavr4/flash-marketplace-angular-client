...
export class SearchServiceClient {
  ...
  searchCraigs(search, category) {
    ...
    let url = 'https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20craigslist.search%20where%20location%3D%22boston%22%20and%20type%3D%22'+category+'%22%20and%20query%3D%22'+search+'%22&format=json&diagnostics=true&env=store%3A%2F%2Fdatatables.org%2Falltableswithkeys';
